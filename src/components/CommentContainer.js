...
const commentsData = [
  {
    name: "Alok kumar",
    text: "hey guys,i m alok ",
    replies: [],
  },
  {
    name: "Ankit kumar",
    text: "like for support ",
    replies: [
      {
        name: "Alok kumar",
        text: "All the best Akshay ❤️ ",
        replies: [],
      },
      {
        name: "Parul kumari",
  ...
  {
    name: "Alok kumar",
    text: "Lorem ipsum dolor sit amet4 ",
    replies: [],
  },
];
const Comment = ({ data }) => {
...
const CommentList = ({ comments }) => {
  //Disclamimrs:don't use index as keys
  return comments.map((commentt, index) => (
    <div key={index}>
      <Comment data={commentt}  />
      <div className="pl-5 border border-l-black ml-5 mt-1 ">
        <CommentList comments={commentt.replies} />
      </div>
    </div>
  ));
};
